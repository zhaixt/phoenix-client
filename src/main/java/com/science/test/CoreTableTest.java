...
//		conn = DriverManager.getConnection("jdbc:mysql://rds6fbqrf6fbqrf.mysql.rds.aliyuncs.com:3306/typhon_00?useUnicode=true&amp;characterEncoding=utf-8","za_dev_typhon","za_dev_typhon_325e3b");

		CoreTableTest test = new CoreTableTest();
//		test.testUpset();
		test.createTable();
	}
	...
	public void testUpset() throws SQLException {
		...
		/*全部53字段*/
		String upsertStr53 = "UPSERT INTO policy6(id, policy_no,apply_no,insurance_certi_no,policy_type,policy_status,channel_id,product_id,contract_id,parent_policy_no," +
...
//		stmt.execute(policyUpsert);
	...
	public void createTable() throws SQLException{
		Statement stmt = conn.createStatement();
		/*建表语句*/
		String createStr= "CREATE TABLE policy6 (\n" +
		"  id bigint(20) NOT NULL primary key ,\n" +
		"  policy_no varchar(50) ,\n" +
		"  apply_no varchar(50),\n" +
		"  insurance_certi_no varchar(50) ,\n" +
